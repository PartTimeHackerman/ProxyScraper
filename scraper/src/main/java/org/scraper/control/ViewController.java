...
public class ViewController extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		FXMLLoader main = new FXMLLoader(getClass().getResource("view.fxml"));
		...
		FXMLLoader bar = new FXMLLoader(getClass().getResource("bar.fxml"));
		rootPane.setTop(bar.load());
		barController = bar.getController();
		
		
		FXMLLoader proxyTable = new FXMLLoader();
		proxyTable.setLocation(getClass().getResource("proxyTable.fxml"));
		...
		FXMLLoader proxyControl = new FXMLLoader(getClass().getResource("proxyControl.fxml"));
		...
		scene.getStylesheets().add(String.valueOf(getClass().getResource("userAgent.css")));
